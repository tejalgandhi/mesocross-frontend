<template>
  <div class="product-page">
    <EquipmentBanner :page-name="'equipment'" />
    ...
    <div class="filter_bar">
      ...
      <div class="container-fluid">
        <div class="row">
          <EquipmentFilter ref="prodcuFilter" class="d-none d-md-block" @fetchProducts="fetchProducts" @priceSort="setSorting" />
          <EquipmentListing :products="products" :paginate="paginate" :loading-finish="loadingFinish" @fetchProducts="fetchProducts" />
        </div>
      </div>
    </div>
...
export default {
  ...
  async asyncData ({ params, $axios, store }) {
    let url = '/equipments?page=1&category_slug=equipment'
